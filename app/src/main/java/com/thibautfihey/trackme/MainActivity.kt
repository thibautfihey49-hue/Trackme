...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.settings.apply {
            ...
            setGeolocationEnabled(true) // ✅ Active la popup de géolocalisation
        }
        
        webView.addJavascriptInterface(WebAppInterface(this), "Android")
        webView.webViewClient = object : WebViewClient() {}
        
        // ✅ LA POPUP COMME UN SITE INTERNET !
        webView.webChromeClient = object : WebChromeClient() {
            override fun onGeolocationPermissionsShowPrompt(
                origin: String,
                callback: GeolocationPermissions.Callback
            ) {
                // ✅ Affiche la popup : "Ce site veut accéder à votre position ?"
        ...
        // ✅ Demande UNIQUEMENT les permissions Android nécessaires en arrière-plan
        checkPermissions()
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == 100) {
            ...
            Toast.makeText(this, if(ok) "✅ Permissions SMS OK" else "⚠️ Permissions SMS manquantes", Toast.LENGTH_SHORT).show()
        }
    }
